...
runApiM :: ∀ a. Context -> Trace -> ApiM a -> Aff (Either LogicException a)
runApiM { postgresStoreClient, postgresEdgeClient, postgresStoreLockClient, rabbitMqClient, s3Client, sesClient } traceContext =
  interpretEventStore
    ▷ interpretQueue
