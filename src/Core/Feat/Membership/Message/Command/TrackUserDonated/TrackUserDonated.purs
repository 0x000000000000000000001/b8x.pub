module Core.Feat.Membership.Message.Command.TrackUserDonated.TrackUserDonated where
...
import Core.Feat.Membership.Message.Command.TrackUserDonated.Result (Result)
...
childTrackUserDonated = child @TrackUserDonated
...
trackUserDonated
  ...
  -> Run
       ...
       Result
trackUserDonated = handleCommand true ◁ TrackUserDonated
