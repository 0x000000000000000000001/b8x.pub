module Core.Feat.Membership.Message.Command.ConsumeMagicLink.ConsumeMagicLink where
...
childConsumeMagicLink = child @ConsumeMagicLink
...
consumeMagicLink
  ...
  -> Run
       ...
       Result
consumeMagicLink = handleCommand true ◁ ConsumeMagicLink
