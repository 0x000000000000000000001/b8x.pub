module Core.Feat.Membership.Message.Command.UnregisterUser.UnregisterUser where
...
import Core.Feat.Membership.Message.Command.UnregisterUser.Result (Result)
...
childUnregisterUser = child @UnregisterUser
...
unregisterUser
  ...
  -> Run
       ...
       Result
unregisterUser = handleCommand true ◁ UnregisterUser
