module Core.Feat.Membership.Message.Command.SendMeMagicLink.SendMeMagicLink where
...
childSendMeMagicLink = child @SendMeMagicLink
...
sendMeMagicLink
  ...
  -> Run
       ...
       Result
sendMeMagicLink = handleCommand true ◁ SendMeMagicLink
