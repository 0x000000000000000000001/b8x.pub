module Core.Feat.Membership.Message.Command.ChangeUserEmail.ChangeUserEmail where
...
import Core.Feat.Membership.Message.Command.ChangeUserEmail.Result (Result)
...
childChangeUserEmail = child @ChangeUserEmail
...
changeUserEmail
  ...
  -> Run
       ...
       Result
changeUserEmail = handleCommand true ◁ ChangeUserEmail
