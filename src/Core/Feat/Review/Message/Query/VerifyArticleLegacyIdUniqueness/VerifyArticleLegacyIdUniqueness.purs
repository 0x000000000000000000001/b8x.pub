module Core.Feat.Review.Message.Query.VerifyArticleLegacyIdUniqueness.VerifyArticleLegacyIdUniqueness where
...
import Core.Feat.Review.Message.Query.VerifyArticleLegacyIdUniqueness.Payload (Payload)
...
verifyArticleLegacyIdUniqueness
  ...
  -> Run
       ...
       Result
verifyArticleLegacyIdUniqueness = Query.handleWithCache ◁ VerifyArticleLegacyIdUniqueness
