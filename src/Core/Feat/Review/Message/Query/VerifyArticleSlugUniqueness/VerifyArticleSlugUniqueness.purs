module Core.Feat.Review.Message.Query.VerifyArticleSlugUniqueness.VerifyArticleSlugUniqueness where
...
import Core.Feat.Review.Message.Query.VerifyArticleSlugUniqueness.Payload (Payload)
import Core.Feat.Review.Message.Query.VerifyArticleSlugUniqueness.Query (VerifyArticleSlugUniqueness(..))
...
verifyArticleSlugUniqueness
  ...
  -> Run
       ...
       Result
verifyArticleSlugUniqueness = Query.handleWithCache ◁ VerifyArticleSlugUniqueness
