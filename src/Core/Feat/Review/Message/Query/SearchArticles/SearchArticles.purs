module Core.Feat.Review.Message.Query.SearchArticles.SearchArticles where
...
import Core.Feat.Review.Message.Query.SearchArticles.Payload (Payload)
...
searchArticles
  ...
  -> Run
       ...
       Result
searchArticles = Query.handleWithCache ◁ SearchArticles
