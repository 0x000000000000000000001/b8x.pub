module Core.Feat.Review.Message.Query.SearchArticles.Projection.Projection where
...
data SearchArticlesProjection

instance
  IsProjection
    SearchArticlesProjection
    "searchArticles"
    "searchArticlesProjectionWriteOps"
    (SEARCH_ARTICLES_PROJECTION_WRITE_OPS ())
    "searchArticlesProjectionReadSyncProject"
    { article :: Article
    , newsTopic :: NewsTopic
    }
  ...
  play = coerce @(SEARCH_ARTICLES_PROJECTION_WRITE_OPS ()) play

type SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx = (searchArticlesProjectionWriteOps :: ProjectionWriteOps | fx)
type SEARCH_ARTICLES_PROJECTION_READ_SYNC_PROJECT fx = (searchArticlesProjectionReadSyncProject :: SyncProject | fx)
type SEARCH_ARTICLES_PROJECTION_READ_FIND fx =
  ARTICLE_SEARCH_ARTICLES_PROJECTION_READ_FIND
    + ARTICLE_NEWS_TOPIC_PROJECTION_READ_FIND
    + fx
...
instance IsPair ArticleKey Article ArticleRecord ArticleIndexNeeds ArticleSortRow "article" "articles" "searchArticlesArticleProjectionReadFind" SearchArticlesProjection where
...
instance IsPair AuthorKey Author AuthorRecord AuthorIndexNeeds () "author" "authors" "searchArticlesAuthorProjectionReadFind" SearchArticlesProjection where
...
instance IsPair EditorKey Editor EditorRecord EditorIndexNeeds () "editor" "editors" "searchArticlesEditorProjectionReadFind" SearchArticlesProjection where
...
instance IsPair BookKey Book BookRecord BookIndexNeeds () "book" "books" "searchArticlesBookProjectionReadFind" SearchArticlesProjection where
...
instance IsPair NewsTopicKey NewsTopic NewsTopicRecord NewsTopicIndexNeeds () "newsTopic" "newsTopics" "searchArticlesNewsTopicProjectionReadFind" SearchArticlesProjection where
...
instance IsPair MagazineIssueKey MagazineIssue MagazineIssueRecord MagazineIssueIndexNeeds () "magazineIssue" "magazineIssues" "searchArticlesMagazineIssueProjectionReadFind" SearchArticlesProjection where
...
instance IsPair CustomSectionKey CustomSection CustomSectionRecord CustomSectionIndexNeeds () "customSection" "customSections" "searchArticlesCustomSectionProjectionReadFind" SearchArticlesProjection where
...
type ARTICLE_SEARCH_ARTICLES_PROJECTION_READ_FIND fx = (searchArticlesArticleProjectionReadFind :: Find Article | fx)
type ARTICLE_SEARCH_ARTICLES_PROJECTION_READ fx =
  ARTICLE_SEARCH_ARTICLES_PROJECTION_READ_FIND
...
findArticles
  ...
  -> Run (ARTICLE_SEARCH_ARTICLES_PROJECTION_READ + fx) (Page Article)
findArticles opt = findMany_ opt { after = opt.after <#> (\id -> ArticleKey { id: Just id, slug: Nothing }) ▷ persistenceKeyFromKey }

type ARTICLE_NEWS_TOPIC_PROJECTION_READ_FIND fx = (searchArticlesNewsTopicProjectionReadFind :: Find NewsTopic | fx)
type ARTICLE_NEWS_TOPIC_PROJECTION_READ fx =
  ARTICLE_NEWS_TOPIC_PROJECTION_READ_FIND
    + SEARCH_ARTICLES_PROJECTION_READ_SYNC_PROJECT
    + fx
...
play :: ∀ fx. LoadedEvent -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
...
onArticleDiscarded :: ∀ fx. ArticleDiscarded.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onArticleDiscarded { article } = delete $ ArticleKey { id: Just article, slug: Nothing }

onArticleWritten :: ∀ fx. Instant -> ArticleWritten.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onArticleWritten
  at
  { id
  , legacyId
...
onAuthorReferenced :: ∀ fx. AuthorReferenced.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onAuthorReferenced { id, name, biography, portrait } = add $ Author { id, name, biography, portrait }

onEditorReferenced :: ∀ fx. EditorReferenced.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onEditorReferenced { id, name } = add $ Editor { id, name }

onBookReferenced :: ∀ fx. BookReferenced.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onBookReferenced { id, name, year, cover, authors, editor } = add $ Book { id, name, year, cover, authors, editor }

onNewsTopicAdded :: ∀ fx. NewsTopicAdded.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onNewsTopicAdded { id, searchInput } = add $ NewsTopic { id, searchInput }

onNewsTopicRemoved :: ∀ fx. NewsTopicRemoved.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onNewsTopicRemoved { newsTopic } = delete $ NewsTopicKey newsTopic

onArticleAddedToNewsRelatedWhitelist :: ∀ fx. ArticleAddedToNewsRelatedWhitelist.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
...
onArticleRemovedFromNewsRelatedWhitelist :: ∀ fx. ArticleRemovedFromNewsRelatedWhitelist.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
...
onMagazineIssueReferenced :: ∀ fx. MagazineIssueReferenced.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onMagazineIssueReferenced { id, slug } = add $ MagazineIssue { id, slug }

onMagazineCustomSectionAdded :: ∀ fx. MagazineCustomSectionAdded.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
onMagazineCustomSectionAdded { id, name } = add $ CustomSection { id, name }

onArticleAddedToNewsRelatedBlacklist :: ∀ fx. ArticleAddedToNewsRelatedBlacklist.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
...
onArticleRemovedFromNewsRelatedBlacklist :: ∀ fx. ArticleRemovedFromNewsRelatedBlacklist.Payload -> Run (SEARCH_ARTICLES_PROJECTION_WRITE_OPS fx) Ɩ
