module Core.Feat.Review.Message.Query.GetArticleQuote.GetArticleQuote where
...
import Core.Feat.Review.Message.Query.GetArticleQuote.Payload (Payload)
...
getArticleQuote
  ...
  -> Run
       ...
       Result
getArticleQuote = Query.handleWithCache ◁ GetArticleQuote
