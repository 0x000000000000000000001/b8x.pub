module Core.Feat.Review.Message.Query.GetArticle.GetArticle where
...
import Core.Feat.Review.Message.Query.GetArticle.Payload (Payload)
...
getArticle
  ...
  -> Run
       ...
       Result
getArticle = Query.handleWithCache ◁ GetArticle
