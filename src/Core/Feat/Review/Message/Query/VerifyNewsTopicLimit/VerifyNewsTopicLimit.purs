module Core.Feat.Review.Message.Query.VerifyNewsTopicLimit.VerifyNewsTopicLimit where
...
import Core.Feat.Review.Message.Query.VerifyNewsTopicLimit.Payload (Payload)
...
verifyNewsTopicLimit
  ...
  -> Run
       ...
       Result
verifyNewsTopicLimit = Query.handleWithCache ◁ VerifyNewsTopicLimit
