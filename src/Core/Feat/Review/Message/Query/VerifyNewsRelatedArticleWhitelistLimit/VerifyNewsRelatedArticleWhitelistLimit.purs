module Core.Feat.Review.Message.Query.VerifyNewsRelatedArticleWhitelistLimit.VerifyNewsRelatedArticleWhitelistLimit where
...
import Core.Feat.Review.Message.Query.VerifyNewsRelatedArticleWhitelistLimit.Payload (Payload)
...
verifyNewsRelatedArticleWhitelistLimit
  ...
  -> Run
       ...
       Result
verifyNewsRelatedArticleWhitelistLimit = Query.handleWithCache ◁ VerifyNewsRelatedArticleWhitelistLimit
