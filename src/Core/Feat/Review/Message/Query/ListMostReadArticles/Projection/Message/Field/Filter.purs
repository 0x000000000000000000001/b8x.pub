module Core.Feat.Review.Message.Query.ListMostReadArticles.Projection.Message.Field.Filter where

import Proem

import Core.Message.Field.Field (class IsField, Sanitized(..), defaultMaybePresence, defaultSanitize, defaultShouldSanitizeInner)
import Core.Feat.Review.Message.Query.ListMostReadArticles.Projection.Projection as Base
