module Core.Feat.Review.Message.Query.ListMostReadArticles.ListMostReadArticles where
...
import Core.Feat.Review.Message.Query.ListMostReadArticles.Payload (Payload)
...
listMostReadArticles
  ...
  -> Run
       ...
       Result
listMostReadArticles = Query.handleWithCache ◁ ListMostReadArticles
