module Core.Feat.Review.Message.Query.GetFrontPage.GetFrontPage where
...
import Core.Feat.Review.Message.Query.GetFrontPage.Payload (Payload)
...
getFrontPage
  ...
  -> Run
       ...
       Result
getFrontPage = Query.handleWithCache ◁ GetFrontPage
