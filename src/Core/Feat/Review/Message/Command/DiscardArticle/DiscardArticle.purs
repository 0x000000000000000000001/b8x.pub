module Core.Feat.Review.Message.Command.DiscardArticle.DiscardArticle where
...
import Core.Feat.Review.Message.Command.DiscardArticle.Result (Result)
...
childDiscardArticle = child @DiscardArticle
...
discardArticle
  ...
  -> Run
       ...
       Result
discardArticle = handleCommand true ◁ DiscardArticle
