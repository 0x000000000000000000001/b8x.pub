module Core.Feat.Review.Message.Command.AddArticleToNewsRelatedBlacklist.AddArticleToNewsRelatedBlacklist where
...
import Core.Feat.Review.Message.Command.AddArticleToNewsRelatedBlacklist.Result (Result)
...
childAddArticleToNewsRelatedBlacklist
  :: ∀ fx
   . Payload
  -> Run
       ( EVENT_STORE
...
childAddArticleToNewsRelatedBlacklist = child @AddArticleToNewsRelatedBlacklist
...
addArticleToNewsRelatedBlacklist
  ...
  -> Run
       ...
       Result
addArticleToNewsRelatedBlacklist = handleCommand true ◁ AddArticleToNewsRelatedBlacklist
