module Core.Feat.Review.Message.Command.WriteArticle.WriteArticle where
...
import Core.Feat.Review.Message.Command.WriteArticle.Result (Result)
...
childWriteArticle = child @WriteArticle
...
writeArticle
  ...
  -> Run
       ...
       Result
writeArticle = handleCommand true ◁ WriteArticle
