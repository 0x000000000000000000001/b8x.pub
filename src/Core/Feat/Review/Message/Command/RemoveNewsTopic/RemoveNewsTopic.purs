module Core.Feat.Review.Message.Command.RemoveNewsTopic.RemoveNewsTopic where
...
import Core.Feat.Review.Message.Command.RemoveNewsTopic.Result (Result)
...
childRemoveNewsTopic = child @RemoveNewsTopic
...
removeNewsTopic
  ...
  -> Run
       ...
       Result
removeNewsTopic = handleCommand true ◁ RemoveNewsTopic
