module Core.Feat.Review.Message.Command.TrackArticleRead.TrackArticleRead where
...
import Core.Feat.Review.Message.Command.TrackArticleRead.Result (Result)
...
childTrackArticleRead = child @TrackArticleRead
...
trackArticleRead
  ...
  -> Run
       ...
       Result
trackArticleRead = handleCommand true ◁ TrackArticleRead
