module Core.Feat.Review.Message.Command.ScheduleNewsletter.ScheduleNewsletter where
...
import Core.Feat.Review.Message.Command.ScheduleNewsletter.Result (Result)
...
childScheduleNewsletter = child @ScheduleNewsletter
...
scheduleNewsletter
  ...
  -> Run
       ...
       Result
scheduleNewsletter = handleCommand true ◁ ScheduleNewsletter
