module Core.Feat.Review.Message.Command.FeatureArticleOnFrontPage.FeatureArticleOnFrontPage where
...
import Core.Feat.Review.Message.Command.FeatureArticleOnFrontPage.Result (Result)
...
childFeatureArticleOnFrontPage
  :: ∀ fx
   . Payload
  -> Run
       ( EVENT_STORE
...
childFeatureArticleOnFrontPage = child @FeatureArticleOnFrontPage
...
featureArticleOnFrontPage
  ...
  -> Run
       ...
       Result
featureArticleOnFrontPage = handleCommand true ◁ FeatureArticleOnFrontPage
