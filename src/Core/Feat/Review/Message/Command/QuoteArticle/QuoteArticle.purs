module Core.Feat.Review.Message.Command.QuoteArticle.QuoteArticle where
...
import Core.Feat.Review.Message.Command.QuoteArticle.Result (Result)
...
childQuoteArticle = child @QuoteArticle
...
quoteArticle
  ...
  -> Run
       ...
       Result
quoteArticle = handleCommand true ◁ QuoteArticle
