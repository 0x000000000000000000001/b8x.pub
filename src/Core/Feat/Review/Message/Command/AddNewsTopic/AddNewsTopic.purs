module Core.Feat.Review.Message.Command.AddNewsTopic.AddNewsTopic where
...
import Core.Feat.Review.Message.Command.AddNewsTopic.Result (Result)
...
childAddNewsTopic = child @AddNewsTopic
...
addNewsTopic
  ...
  -> Run
       ...
       Result
addNewsTopic = handleCommand true ◁ AddNewsTopic
