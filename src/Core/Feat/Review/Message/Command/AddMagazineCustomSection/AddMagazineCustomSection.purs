module Core.Feat.Review.Message.Command.AddMagazineCustomSection.AddMagazineCustomSection where
...
import Core.Feat.Review.Message.Command.AddMagazineCustomSection.Result (Result)
...
childAddMagazineCustomSection = child @AddMagazineCustomSection
...
addMagazineCustomSection
  ...
  -> Run
       ...
       Result
addMagazineCustomSection = handleCommand true ◁ AddMagazineCustomSection
