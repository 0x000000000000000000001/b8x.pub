module Core.Feat.Review.Message.Command.AddArticleToNewsRelatedWhitelist.AddArticleToNewsRelatedWhitelist where
...
import Core.Feat.Review.Message.Command.AddArticleToNewsRelatedWhitelist.Result (Result)
...
childAddArticleToNewsRelatedWhitelist
  :: ∀ fx
   . Payload
  -> Run
       ( EVENT_STORE
...
childAddArticleToNewsRelatedWhitelist = child @AddArticleToNewsRelatedWhitelist
...
addArticleToNewsRelatedWhitelist
  ...
  -> Run
       ...
       Result
addArticleToNewsRelatedWhitelist = handleCommand true ◁ AddArticleToNewsRelatedWhitelist
