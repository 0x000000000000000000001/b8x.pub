module Core.Feat.Newsletter.Message.Query.VerifyNewsletterUniqueness.VerifyNewsletterUniqueness where
...
import Core.Feat.Newsletter.Message.Query.VerifyNewsletterUniqueness.Payload (Payload)
...
verifyNewsletterUniqueness
  ...
  -> Run
       ...
       Result
verifyNewsletterUniqueness = Query.handleWithCache ◁ VerifyNewsletterUniqueness
