module Core.Feat.Newsletter.Message.Query.SearchNewsletters.Field.Sort where
...
import Core.Feat.Newsletter.Message.Query.SearchNewsletters.Projection.Projection (NewsletterSortCriteria)
import Yoga.JSON (class ReadForeign, class WriteForeign)
import Data.Newtype (class Newtype)

type Sort = NewsletterSortCriteria
