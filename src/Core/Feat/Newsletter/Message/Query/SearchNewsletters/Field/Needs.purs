module Core.Feat.Newsletter.Message.Query.SearchNewsletters.Field.Needs where
...
defaultNeeds =
  { id: NotNeeded
  , scheduledFor: NotNeeded
  , articles: NotNeeded
  }

type NeedsFieldChildren =
  (id :: NeedField Ɩ Ɩ
  , scheduledFor :: NeedField Ɩ Ɩ
  , articles :: NeedField Ɩ Ɩ
  )

newtype NeedsField = NeedsField Needs

description :: String
description = "Newsletter needs"
