module Core.Feat.Newsletter.Message.Command.PrefillNewsletterCampaignEmail.PrefillNewsletterCampaignEmail where
...
childPrefillNewsletterCampaignEmail
  :: ∀ fx
   . Payload
  -> Run
       ( EVENT_STORE
...
childPrefillNewsletterCampaignEmail = child @PrefillNewsletterCampaignEmail
...
prefillNewsletterCampaignEmail
  ...
  -> Run
       ...
       Result
prefillNewsletterCampaignEmail = handleCommand true ◁ PrefillNewsletterCampaignEmail
