module Core.Feat.Newsletter.Message.Command.AddNewsletterSubscriber.AddNewsletterSubscriber where
...
childAddNewsletterSubscriber = child @AddNewsletterSubscriber
...
addNewsletterSubscriber
  ...
  -> Run
       ...
       Result
addNewsletterSubscriber = handleCommand true ◁ AddNewsletterSubscriber
