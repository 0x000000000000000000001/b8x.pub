module Core.Feat.Reference.Message.Query.SearchAuthors.SearchAuthors where
...
import Core.Feat.Reference.Message.Query.SearchAuthors.Payload (Payload)
...
searchAuthors
  ...
  -> Run
       ...
       Result
searchAuthors = Query.handleWithCache ◁ SearchAuthors
