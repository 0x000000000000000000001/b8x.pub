module Core.Feat.Reference.Message.Query.VerifyBookUniqueness.VerifyBookUniqueness where
...
import Core.Feat.Reference.Message.Query.VerifyBookUniqueness.Payload (Payload)
...
verifyBookUniqueness
  ...
  -> Run
       ...
       Result
verifyBookUniqueness = Query.handleWithCache ◁ VerifyBookUniqueness
