module Core.Feat.Reference.Message.Query.GetAuthor.GetAuthor where
...
import Core.Feat.Reference.Message.Query.GetAuthor.Payload (Payload)
...
getAuthor
  ...
  -> Run
       ...
       Result
getAuthor = Query.handleWithCache ◁ GetAuthor
