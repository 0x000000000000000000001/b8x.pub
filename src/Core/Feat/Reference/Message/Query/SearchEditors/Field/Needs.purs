module Core.Feat.Reference.Message.Query.SearchEditors.Field.Needs where
...
defaultNeeds =
  { id: NotNeeded
  , name: NotNeeded
  , legacyBookIds: NotNeeded
  }

type NeedsFieldChildren =
  (id :: NeedField Ɩ Ɩ
  , name :: NeedField Ɩ Ɩ
  , legacyBookIds :: NeedField Ɩ Ɩ
  )

newtype NeedsField = NeedsField Needs

description :: String
description = "Editor needs"
