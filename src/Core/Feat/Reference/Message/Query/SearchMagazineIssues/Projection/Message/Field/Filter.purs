module Core.Feat.Reference.Message.Query.SearchMagazineIssues.Projection.Message.Field.Filter where

import Proem

import Core.Message.Field.Field (class IsField, Sanitized(..), defaultMaybePresence, defaultSanitize, defaultShouldSanitizeInner)
import Core.Feat.Reference.Message.Query.SearchMagazineIssues.Projection.Projection as Base
import Yoga.JSON (class ReadForeign, class WriteForeign)
import Data.Maybe (Maybe(..))
import Data.Newtype (class Newtype)

type Filter = Maybe Base.MagazineIssueFilter

newtype FilterField = FilterField Filter

description :: String
description = "Magazine issue filter"
