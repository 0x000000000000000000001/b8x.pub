module Core.Feat.Reference.Message.Query.SearchMagazineIssues.Exception.InvalidMagazineIssueFilter where
...
instance IsLogicException InvalidMagazineIssueFilter (InvalidMagazineIssueFilterRow r) where
  inj = Variant.inj (π @"Core.Feat.Reference.Message.Query.SearchMagazineIssues.Exception.InvalidMagazineIssueFilter")
