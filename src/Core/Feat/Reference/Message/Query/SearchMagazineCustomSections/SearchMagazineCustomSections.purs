module Core.Feat.Reference.Message.Query.SearchMagazineCustomSections.SearchMagazineCustomSections where
...
import Core.Feat.Reference.Message.Query.SearchMagazineCustomSections.Payload (Payload)
...
searchMagazineCustomSections
  ...
  -> Run
       ...
       Result
searchMagazineCustomSections = Query.handleWithCache ◁ SearchMagazineCustomSections
