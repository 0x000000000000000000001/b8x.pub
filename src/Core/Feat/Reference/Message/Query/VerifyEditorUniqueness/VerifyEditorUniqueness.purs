module Core.Feat.Reference.Message.Query.VerifyEditorUniqueness.VerifyEditorUniqueness where
...
import Core.Feat.Reference.Message.Query.VerifyEditorUniqueness.Payload (Payload)
...
verifyEditorUniqueness
  ...
  -> Run
       ...
       Result
verifyEditorUniqueness = Query.handleWithCache ◁ VerifyEditorUniqueness
