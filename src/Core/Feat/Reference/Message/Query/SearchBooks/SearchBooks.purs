module Core.Feat.Reference.Message.Query.SearchBooks.SearchBooks where
...
import Core.Feat.Reference.Message.Query.SearchBooks.Payload (Payload)
...
searchBooks
  ...
  -> Run
       ...
       Result
searchBooks = Query.handleWithCache ◁ SearchBooks
