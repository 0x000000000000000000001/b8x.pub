module Core.Feat.Reference.Message.Query.SearchBooks.Exception.InvalidBookFilter where
...
type InvalidBookFilterRow r =
  ("Core.Feat.Reference.Message.Query.SearchBooks.Exception.InvalidBookFilter" ∷ InvalidBookFilter
  | r
  )
...
instance IsLogicException InvalidBookFilter (InvalidBookFilterRow r) where
  inj = Variant.inj (π @"Core.Feat.Reference.Message.Query.SearchBooks.Exception.InvalidBookFilter")
