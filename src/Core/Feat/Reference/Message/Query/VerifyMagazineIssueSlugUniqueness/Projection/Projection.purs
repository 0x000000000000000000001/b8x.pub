module Core.Feat.Reference.Message.Query.VerifyMagazineIssueSlugUniqueness.Projection.Projection where
...
data VerifyMagazineIssueSlugUniquenessProjection

instance
  IsProjection
    VerifyMagazineIssueSlugUniquenessProjection
    "verifyMagazineIssueSlugUniqueness"
    "verifyMagazineIssueSlugUniquenessProjectionWriteOps"
    (VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_WRITE_OPS ())
    "verifyMagazineIssueSlugUniquenessProjectionReadSyncProject"
    { verifyMagazineIssueSlugUniqueness :: MagazineIssue }
    { verifyMagazineIssueSlugUniqueness :: MagazineIssueIndexNeeds }
    { verifyMagazineIssueSlugUniqueness :: Record () }
  where
  indexNeeds =
    { verifyMagazineIssueSlugUniqueness:
        { id: rawIndexOnly
  ...
  play = coerce @(VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_WRITE_OPS ()) play

type VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_WRITE_OPS fx = (verifyMagazineIssueSlugUniquenessProjectionWriteOps :: ProjectionWriteOps | fx)
type VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_READ_SYNC_PROJECT fx = (verifyMagazineIssueSlugUniquenessProjectionReadSyncProject :: SyncProject | fx)
...
instance
  IsPair
    ...
    ()
    "verifyMagazineIssueSlugUniqueness"
    "verifyMagazineIssueSlugUniquenessMagazineIssues"
    "verifyMagazineIssueSlugUniquenessProjectionReadFind"
    VerifyMagazineIssueSlugUniquenessProjection
  where
...
type VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_READ_FIND fx = (verifyMagazineIssueSlugUniquenessProjectionReadFind :: Find MagazineIssue | fx)
type VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_READ fx =
...
findMagazineIssueBySlug
  :: ∀ fx
   . Slug
  -> Run (VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_READ + fx) (Maybe MagazineIssue)
findMagazineIssueBySlug slug = findOneBy @MagazineIssue @"slug" StrictlyEquals slug

-- Play

play :: ∀ fx. LoadedEvent -> Run (VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_WRITE_OPS fx) Ɩ
...
onMagazineIssueReferenced :: ∀ fx. MagazineIssueReferenced.Payload -> Run (VERIFY_MAGAZINE_ISSUE_SLUG_UNIQUENESS_PROJECTION_WRITE_OPS fx) Ɩ
