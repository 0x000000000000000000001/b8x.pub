module Core.Feat.Reference.Message.Query.VerifyMagazineIssueSlugUniqueness.VerifyMagazineIssueSlugUniqueness where
...
import Core.Feat.Reference.Message.Query.VerifyMagazineIssueSlugUniqueness.Payload (Payload)
...
verifyMagazineIssueSlugUniqueness
  ...
  -> Run
       ...
       Result
verifyMagazineIssueSlugUniqueness = Query.handleWithCache ◁ VerifyMagazineIssueSlugUniqueness
