module Core.Feat.Reference.Message.Command.DereferenceEditor.DereferenceEditor where
...
import Core.Feat.Reference.Message.Command.DereferenceEditor.Result (Result)
...
childDereferenceEditor = child @DereferenceEditor
...
dereferenceEditor
  ...
  -> Run
       ...
       Result
dereferenceEditor = handleCommand true ◁ DereferenceEditor
