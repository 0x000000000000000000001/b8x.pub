module Core.Feat.Reference.Message.Command.DereferenceBook.DereferenceBook where
...
import Core.Feat.Reference.Message.Command.DereferenceBook.Result (Result)
...
childDereferenceBook = child @DereferenceBook
...
dereferenceBook
  ...
  -> Run
       ...
       Result
dereferenceBook = handleCommand true ◁ DereferenceBook
