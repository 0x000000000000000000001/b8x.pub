module Core.Feat.Reference.Message.Command.ReferenceBook.ReferenceBook where
...
import Core.Feat.Reference.Message.Command.ReferenceBook.Result (Result)
...
childReferenceBook = child @ReferenceBook
...
referenceBook
  ...
  -> Run
       ...
       Result
referenceBook = handleCommand true ◁ ReferenceBook
