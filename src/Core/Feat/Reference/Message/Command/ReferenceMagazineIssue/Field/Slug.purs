module Core.Feat.Reference.Message.Command.ReferenceMagazineIssue.Field.Slug where
...
import Core.Mod.MagazineIssue.Slug.Message.Field.Slug as BaseField
