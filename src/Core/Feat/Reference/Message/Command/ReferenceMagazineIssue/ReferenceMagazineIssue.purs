module Core.Feat.Reference.Message.Command.ReferenceMagazineIssue.ReferenceMagazineIssue where
...
import Core.Feat.Reference.Message.Command.ReferenceMagazineIssue.Result (Result)
...
childReferenceMagazineIssue = child @ReferenceMagazineIssue
...
referenceMagazineIssue
  ...
  -> Run
       ...
       Result
referenceMagazineIssue = handleCommand true ◁ ReferenceMagazineIssue
