module Core.Feat.Reference.Message.Command.ReferenceEditor.ReferenceEditor where
...
import Core.Feat.Reference.Message.Command.ReferenceEditor.Result (Result)
...
childReferenceEditor = child @ReferenceEditor
...
referenceEditor
  ...
  -> Run
       ...
       Result
referenceEditor = handleCommand true ◁ ReferenceEditor
