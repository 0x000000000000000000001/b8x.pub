module Core.Feat.Reference.Message.Command.DereferenceAuthor.DereferenceAuthor where
...
import Core.Feat.Reference.Message.Command.DereferenceAuthor.Result (Result)
...
childDereferenceAuthor = child @DereferenceAuthor
...
dereferenceAuthor
  ...
  -> Run
       ...
       Result
dereferenceAuthor = handleCommand true ◁ DereferenceAuthor
