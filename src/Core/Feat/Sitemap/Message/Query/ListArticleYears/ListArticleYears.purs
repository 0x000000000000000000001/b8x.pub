module Core.Feat.Sitemap.Message.Query.ListArticleYears.ListArticleYears where
...
import Core.Feat.Sitemap.Message.Query.ListArticleYears.Payload (Payload)
...
listArticleYears
  ...
  -> Run
       ...
       Result
listArticleYears payload = Query.handleWithCache (ListArticleYears payload)
