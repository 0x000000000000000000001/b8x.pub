module Core.Feat.Sitemap.Message.Query.ListMagazineIssues.ListMagazineIssues where
...
import Core.Feat.Sitemap.Message.Query.ListMagazineIssues.Payload (Payload)
...
listMagazineIssues
  ...
  -> Run
       ...
       Result
listMagazineIssues payload = Query.handleWithCache (ListMagazineIssues payload)
