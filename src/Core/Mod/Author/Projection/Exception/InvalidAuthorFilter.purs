module Core.Mod.Author.Projection.Exception.InvalidAuthorFilter where
...
type InvalidAuthorFilterRow r =
  ("Core.Mod.Author.Projection.Exception.InvalidAuthorFilter" ∷ InvalidAuthorFilter
  | r
  )
...
instance IsLogicException InvalidAuthorFilter (InvalidAuthorFilterRow r) where
  inj = Variant.inj (π @"Core.Mod.Author.Projection.Exception.InvalidAuthorFilter")
