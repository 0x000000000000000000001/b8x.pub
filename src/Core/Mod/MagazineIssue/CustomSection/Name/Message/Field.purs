module Core.Mod.MagazineIssue.CustomSection.Name.Message.Field where

import Proem
import Control.Monad.Except as Control.Monad.Except

import Core.Message.Field.Field (class IsField, Presence(..), Sanitized(..), defaultShouldSanitizeInner)
import Core.Mod.MagazineIssue.CustomSection.Name.Name as Base
...
description :: String
description = "Magazine custom section name"
