module Core.Mod.Article.Slug.Exception where
...
type SlugExceptionRow r = ("Core.Mod.Article.Slug.Exception" ∷ InvalidSlug | r)
...
instance IsLogicException InvalidSlug (SlugExceptionRow r) where
  inj = Variant.inj (π @"Core.Mod.Article.Slug.Exception")
