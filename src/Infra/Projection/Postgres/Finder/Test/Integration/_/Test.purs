module Infra.Projection.Postgres.Finder.Test.Integration.Test where
...
import Infra.Projection.Postgres.Finder.Test.Integration.HandleProjectionReadFind as HandleProjectionReadFind
import Infra.Projection.Postgres.Finder.Test.Integration.TestM (runTestM)
          ...
          bracket
            ...
            ( \_ ->
                bracket
                  ...
                  (\{ postgresStoreClient, postgresEdgeClient, postgresStoreLockClient } -> runTestM { postgresStoreClient, postgresEdgeClient, postgresStoreLockClient, rabbitMqClient } testBlock)
            )
      )
      HandleProjectionReadFind.spec
